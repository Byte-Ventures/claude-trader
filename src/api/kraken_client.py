...
class KrakenClient:
    ...
    def limit_buy_post_only(
        ...
        """
        Execute a limit buy order with POST_ONLY (maker-only).

        Order is rejected if it would immediately match. Earns maker rebates.
        ...
        try:
            ...
            order_data = {
                ...
                "price": str(limit_price),
                "volume": str(base_size),
                "oflags": "post",  # Post-only (maker) order
            }
            ...
            logger.error(
                "kraken_limit_buy_post_only_failed",
                error=str(e),
                product_id=product_id,
                base_size=str(base_size),
                limit_price=str(limit_price),
    ...
    def limit_sell_post_only(
        ...
        """
        Execute a limit sell order with POST_ONLY (maker-only).
        ...
        try:
            ...
            logger.error(
                "kraken_limit_sell_post_only_failed",
                error=str(e),
                product_id=product_id,
                base_size=str(base_size),
                limit_price=str(limit_price),
