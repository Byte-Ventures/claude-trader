...
class Settings(BaseSettings):
    ...
    signal_threshold: int = Field(
        default=65,  # Consider 70 for fewer, higher-quality trades
        ge=40,
        le=100,
    ...
    min_take_profit_percent: float = Field(
        ...
        ge=0.5,
        le=5.0,
        description="Minimum take-profit distance as percentage (must exceed round-trip fees)"
    )
    ...
    # When judge disapproves: <60% proceed, 60-74% reduce, >=75% skip
